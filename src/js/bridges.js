      ...
      <TextInputQuestion
        cardData={{
          questionInfo: {
            ...
            description: "Название моста связано с его местоположением: 1-й Садовый мост окружен зелеными насаждениями со всех четырех сторон. Выберите из списка названия этих насаждений:\n" +
              "1. Зимний сад\n" +
              "2. Михайловский сквер\n" +
              "3. Марсово поле\n" +
              "4. Михайловский сад\n" +
              "5. Летний сад\n" +
              "6. сквер у Инженерного Замка.\n",
      ...
      <TextInputQuestion
        cardData={{
          questionInfo: {
            ...
            hint: "ОТВЕТ: единорог лягушка морской конёк (но пока что введите просто единорог)\n" +
  ...
  },
  {
    ...
    overlayComponent: (onQuestionSolved) => (
      <DefaultQuestion
        ...
        options={[
          { text: "мужа, Москве, обеспечивать, открыть бизнес", correct: false },
          { text: "мужчину, Сочи, катать на своей яхте, переехать в Москву", correct: false },
          { text: "парня, Брянске, поддерживать, сдать экзамены", correct: true },
        ]}
      />
    ),
  },
