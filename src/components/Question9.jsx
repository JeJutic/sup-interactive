...
function Content() {
    ...
    const element = dataGen(state, setState).find((e) => e.state == state);
    const b = !!element.moveScreen;
    return (
        <div
            className={`${styles["content-wrapper"]} ${b ? styles["move-screen"] : ""
                }`}
        >
            {element.data}
        </div>
